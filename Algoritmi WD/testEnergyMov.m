function [startw, endw] = testEnergyMov(m, step, size)
...
% Viene calcolata la media mobile per smussare la magnitudine
% dell'accelerazione

magn = movingmean(m,30);
...
plot(1:length(magn), magn, 'b', times, data, 'b', 'LineWidth', 1);

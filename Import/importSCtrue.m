function groundtruthSC = importSCtrue(filename, startRow, endRow)
% Importa il file contenente i valori reali di SC
%IMPORTFILE Import numeric data from a text file as a matrix.
%   GROUNDTRUTHSC = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   GROUNDTRUTHSC = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   groundtruthSC = importfile('groundtruth_SC.txt', 1, 77);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2014/12/14 18:00:56
...
groundtruthSC = [dataArray{1:end-1}];
